...
describe('Central de atendimento TAT', function(){
    ...
    it('preenche os campos obrigatórios e envia o formulário', () => {
        ...
        const choraDokas = 'chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora chora'

        cy.get('#firstName').type('Rafael')
        cy.get('#lastName').type('Freitas')
        cy.get('#email').type('rafa@exemplo.com')
        cy.get('#open-text-area').type(choraDokas)
